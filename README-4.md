...
ACI is conceptually grounded in **AURA (Artificial Unified Resonance Architecture)**, which introduces **TM–BM resonance** as a bounded meaning-state generation mechanism. In AURA, Temporal Memory (TM) represents the active present context, while Bold Memory (BM) represents continuity-weighted memory anchors. This is not the same as classical short-term memory / long-term memory (STM/LTM). STM/LTM mainly describes where information is stored and how long it persists; TM–BM resonance describes how present context becomes meaningful through interaction with continuity-weighted memory.
...
| **R(TM, BM)** | TM–BM resonance — semantic alignment between the current Temporal Memory state and Bold Memory anchors. In ACI-Drive, BM anchors represent safe-operation states; in the broader AURA framework, BM anchors represent continuity-weighted meaning anchors. |
...
ACI extends the AURA TM–BM resonance principle from bounded meaning-state generation into runtime continuity monitoring.

AURA asks:

> **Why does this situation matter to this system at this moment?**

ACI asks:

> **Is the system's current semantic state still continuous, stable, and safe relative to its memory anchors?**

In classical STM/LTM systems, memory is primarily treated as storage, retrieval, or temporary processing. In AURA, memory has a different computational role: meaning is generated through resonance between the active present state (TM) and continuity-weighted Bold Memory (BM). ACI extends this idea from meaning-state generation to runtime continuity-health monitoring.

| Framework | Main role | Output |
|---|---|---|
| **AURA** | Generates bounded meaning-state from TM–BM resonance | E₀ |
| **ACI** | Monitors runtime continuity health using resonance, instability, and angular drift | Λ(t) |
| **Silent Alarm** | Activates protective monitoring when continuity degradation or external risk crosses calibrated thresholds | Alarm state |

Related work: [AURA: A Dual-Memory Resonance Architecture for Bounded Meaning-State Generation in Memory-Bearing AI Systems](https://doi.org/10.5281/zenodo.19941992)

---

## 🧠 TM–BM Resonance Is Not STM/LTM

| Dimension | Classical STM/LTM | TM–BM Resonance |
|---|---|---|
| Main question | Where is information stored? | Why does this situation matter now? |
| Memory role | Storage, retrieval, temporary processing | Continuity-weighted meaning generation |
| Present/past relation | Separate stores, queried when needed | Present context interpreted through BM anchors |
| Output | Retrieved information or active buffer | Bounded meaning/continuity signal |
| Relevance to AURA/ACI | Background memory taxonomy | Core computational mechanism |

> **STM/LTM explains where information lives; TM–BM resonance explains how meaning and continuity are computed.**
...
Although ACI is conceptually related to AURA, the current ACI repository remains a simulation-stage research prototype. AURA supports the theoretical TM–BM resonance foundation; it does not make ACI safety-certified or production-ready.

---

## 🧪 Reviewer-Safe Novelty Statement

ACI should not be read as a generic replacement for anomaly detection, OOD detection, uncertainty estimation, or certified runtime safety systems.

Its specific contribution is the formulation of a black-box-compatible runtime continuity index that combines:

- TM–BM resonance against memory anchors,
- local semantic instability σ(t),
- angular semantic drift Δφ(t),
- bounded Λ(t) continuity scoring,
- Silent Alarm thresholding,
- and separation between internal continuity degradation Λ(t) and external real-world risk S(t).

This makes ACI a continuity-monitoring extension of the AURA resonance framework rather than a simple cosine-similarity alarm.

---

## 🔗 Related Research

This ACI repository is part of a broader continuity-first research programme.

| Work | Role | DOI |
|---|---|---|
| **AURA — Artificial Unified Resonance Architecture** | Dual-memory resonance architecture for bounded meaning-state generation. Introduces the TM–BM resonance principle that conceptually supports ACI. | [10.5281/zenodo.19941992](https://doi.org/10.5281/zenodo.19941992) |
| **ACI — Alim-Continuity Index** | Runtime continuity metric and Silent Alarm architecture for memory-bearing autonomous AI systems. | [10.5281/zenodo.19940908](https://doi.org/10.5281/zenodo.19940908) |
