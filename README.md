...
[![Version](https://img.shields.io/badge/version-1.0-06d6f5?style=flat-square&logo=github&logoColor=white)](https://github.com/alimulhaqkhan-prog/alim-continuity-index)
[![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.19201362-a855f7?style=flat-square&logo=zenodo&logoColor=white)](https://doi.org/10.5281/zenodo.19201362)
...
[🌐 **Live Demo**](https://alimulhaqkhan-prog.github.io/alim-continuity-index/) · [📄 **Research Archive**](https://doi.org/10.5281/zenodo.19201362) · [👤 **Author**](#-author) · [📐 **Theory**](#-formal-properties)
...
$$\Lambda(t) = R(TM,\ BM)\cdot \exp\!\bigl(-(\alpha\cdot\sigma(t)+\beta\cdot\Delta\phi(t))\bigr)$$
...
$$W(t) = \text{EMA}_{\rho}\bigl(\Lambda(t) - \Lambda(t-1)\bigr), \quad \rho = 0.3$$
...
| 🧠 **Bold Memory** | Manage persistent safe-operation BM identity anchors — add, export, reset |
...
│
├── index.html                     ← Full interactive ACI Lab v1.0 prototype
├── README.md                      ← Project documentation
└── ACIDrive_Simulation_v2.ipynb   ← Frozen notebook referenced in the paper;
                                      may be added after journal technical check
```
...
@misc{khan2026alimcontinuity,
  ...
  year         = {2026},
  publisher    = {Zenodo},
  doi          = {10.5281/zenodo.19201362},
  url          = {https://doi.org/10.5281/zenodo.19201362},
  note         = {Simulation-stage research prototype. UK Patent Application GB2518804.6.}
}
```
...
[![Zenodo](https://img.shields.io/badge/Zenodo-Research_Archive-a855f7?style=flat-square&logo=zenodo&logoColor=white)](https://doi.org/10.5281/zenodo.19201362)
...
[🌐 Live Demo](https://alimulhaqkhan-prog.github.io/alim-continuity-index/) · [📄 Zenodo DOI](https://doi.org/10.5281/zenodo.19201362) · [🐙 GitHub](https://github.com/alimulhaqkhan-prog/alim-continuity-index)
